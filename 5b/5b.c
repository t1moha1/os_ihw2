...
#define SEM_CATALOG    "/sem_catalog"
...
int main(int argc, char *argv[]) {
    ...
    int *catalog_size = (int *)cat; //Указатель на размер
    *catalog_size = 0;
    
    Book *catalog = (Book *)((char *)cat + sizeof(int)); //Указатель на начало каталога

    //Создаем симафор
    sem_t *sem_cat = sem_open(SEM_CATALOG, O_CREAT, 0666, 1);
